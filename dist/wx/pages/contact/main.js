...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_mpvue_loader_lib_template_compiler_index_id_data_v_c7e80b78_hasScoped_false_transformToRequire_video_src_source_src_img_src_image_xlink_href_fileExt_template_wxml_script_js_style_wxss_platform_wx_node_modules_mpvue_loader_lib_selector_type_template_index_0_index_vue__ = __webpack_require__(161);
var disposed = false
...
var Component = normalizeComponent(
  ...
  __WEBPACK_IMPORTED_MODULE_1__node_modules_mpvue_loader_lib_template_compiler_index_id_data_v_c7e80b78_hasScoped_false_transformToRequire_video_src_source_src_img_src_image_xlink_href_fileExt_template_wxml_script_js_style_wxss_platform_wx_node_modules_mpvue_loader_lib_selector_type_template_index_0_index_vue__["a" /* default */],
  __vue_styles__,
  __vue_scopeId__,
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-c7e80b78", Component.options)
  } else {
    hotAPI.reload("data-v-c7e80b78", Component.options)
  }
  ...
  methods: {
    ...
    initFriendsList: function initFriendsList() {
      ...
      wx.$app.getFriendList({
        ...
        var C2CUserList = _this2.allConversation.filter(function (_ref) {
          var type = _ref.type;
          return type === wx.TIM.TYPES.CONV_C2C;
        }).map(function (_ref2) {
          var userProfile = _ref2.userProfile;
          return { userID: userProfile.userID, profile: userProfile };
        });
        var tempList = [].concat(__WEBPACK_IMPORTED_MODULE_1_babel_runtime_helpers_toConsumableArray___default()(res.data), __WEBPACK_IMPORTED_MODULE_1_babel_runtime_helpers_toConsumableArray___default()(C2CUserList));
        var groupedFriends = _this2.groupingFriendList(tempList);
    ...
    groupingFriendList: function groupingFriendList(friends) {
      ...
      friends.forEach(function (friend) {
        ...
        var firstWord = Object(__WEBPACK_IMPORTED_MODULE_3__utils_index__["d" /* pinyin */])(name)[0].toUpperCase();
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-c7e80b78", esExports)
  }
}
